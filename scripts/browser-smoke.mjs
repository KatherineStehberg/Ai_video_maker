...
try{
  ...
  const result={browser:await browser.version(),upload:true,previewDecode:true,seek:true,playback:true,rows:5,exports:['json','csv'],pageErrors:errors,consentUI:'verified with mock config and upload',gemini:'not called'};
